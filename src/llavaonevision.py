...
class LLaVAOneVisionModel:
    """Wrapper class for LLaVA-OneVision model inference."""
    ...
    def __init__(
        ...
        # Tie weights if the method exists
        if hasattr(self.model, 'tie_weights'):
            self.model.tie_weights()
        else:
            print("Warning: The model does not have a 'tie_weights' method.")
    ...
    def generate(
        ...
        **kwargs,
        ...
        Args:
            ...
            input_images: Path(s), URL(s), or PIL.Image(s) for input image(s)
    ...
    def _build_messages(
        ...
        """
        Build messages in the format required by LLaVA-OneVision.
        
        Args:
            system_prompt: System prompt
            user_prompt: User prompt
            input_images: Image path(s), URL(s), or PIL.Image(s)
